...
{
    internal class TSSHA256
    {
        #region Consts

        private readonly int m_block_size = 64;
        private readonly int m_hash_size = 32;
        public static int BUFFER_SIZE = 64 * 1024;
        protected readonly uint[] m_state = new uint[8];
        protected readonly HashBuffer m_buffer = new HashBuffer(64);
        protected ulong m_processed_bytes = 0;
        ...
        public HashResult TransformFinal()
        {
            ...
            Debug.Assert(result.Length == m_hash_size);
